...
urlpatterns = [
    ...
    path('create', loans.post_loans, name='post_loans'),
    path('<uuid:id>', loans.get_loans_by_id, name='get_loan_by_id'),
    path('<uuid:id>/balance', balance_due.get_balance_due, name='get_balance_due'),
